...
class ObjectClassification(Task):
    ...
    def _get_models(self):
        ...
        detection_model = self._pipeline._document["detection-model"]
        ...
        for classification_model in self._pipeline._document["classification-models"]:
